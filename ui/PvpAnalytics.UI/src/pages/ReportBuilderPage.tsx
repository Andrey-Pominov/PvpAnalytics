...
import { useReportBuilderStore, type WidgetType } from '../store/reportBuilderStore'
...
const ReportBuilderPage = () => {
  ...
  const renderWidget = (widget: typeof currentLayout.widgets[0]) => {
    ...
    switch (widget.type) {
      ...
      case 'chart':
        return (
          <div className="flex h-full items-center justify-center rounded-lg border border-accent-muted/40 bg-surface/50 text-text-muted">
